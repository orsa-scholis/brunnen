...
unangenehm = AnswerPossibility.create!(value: 0, description: 'Viel zu laut')
mittel = AnswerPossibility.create!(value: 1, description: 'Zu laut')
neutral = AnswerPossibility.create!(value: 2, description: 'Erträglich')
einigermassen_gut = AnswerPossibility.create!(value: 3, description: 'Leise')
total_geil = AnswerPossibility.create!(value: 4, description: 'Ziemlich leise')
